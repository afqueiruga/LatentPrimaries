...
Representation learning methods such as StyleGAN and G|FLOW have shown
...
the bi-species hydrate phase comes into play.
The liquid-gas-equilibrium-supercritical state transition comes into
play in, for example, in geoengineered systems using $CO_2$
...
gases, such as a Peng-Robinsion equation \cite{peng_new_1976}, are
...
\begin{figure}
\centering
\includegraphics{../slides/classifier_network.png}
